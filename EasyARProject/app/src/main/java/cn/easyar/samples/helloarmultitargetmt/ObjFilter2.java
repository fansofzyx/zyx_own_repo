...
public class ObjFilter2 extends AFilter {
    ...
    protected void onCreate() {
        createProgramByAssetsFile("obj2.vert","obj2.frag");
        ...
        if(obj!=null&&obj.mtl!=null){
            try {
                ...
                textureId=createTexture(BitmapFactory.decodeStream(mRes.getAssets().open(obj.mtl.map_Kd)));
...
//        super.onClear();
    ...
    @Override
    protected void onDraw(Matrix44F projectionMatrix, Matrix44F cameraview) {
        GLES20.glUniformMatrix4fv(pos_proj_box, 1, false, projectionMatrix.data, 0);
        GLES20.glUniformMatrix4fv(mHMatrix, 1, false, cameraview.data, 0);
